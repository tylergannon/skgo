...
// The adapter is published to npm as @skgo/sveltekit-adapter and embedded in this module,
...
// packageFiles is what a developer who runs `pnpm add -D @skgo/sveltekit-adapter` must
